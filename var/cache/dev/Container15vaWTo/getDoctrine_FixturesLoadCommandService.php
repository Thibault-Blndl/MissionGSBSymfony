...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\EtatFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\FicheFraisFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\TypeUserFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\UserFixtures(($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService'))), 'groups' => []]]);
