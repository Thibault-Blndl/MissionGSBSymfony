 ...
 */
final class Version20210319214108 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ligne_frais_forfait (id INT AUTO_INCREMENT NOT NULL, frais_forfait_id INT DEFAULT NULL, fiche_frais_id INT DEFAULT NULL, quantite INT DEFAULT NULL, UNIQUE INDEX UNIQ_BD293ECF7B70375E (frais_forfait_id), INDEX IDX_BD293ECFD94F5755 (fiche_frais_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
